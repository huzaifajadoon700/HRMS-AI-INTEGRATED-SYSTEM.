/**
 * Footer Component for HRMS Frontend
 * Comprehensive footer with contact info, social links, and newsletter
 *
 * @description Responsive footer with hotel amenities and company information
 * @version 1.0.0
 */
      ...
      >
        ...
        <div
          style={{
            ...
            height: "150px",
            background:
              "radial-gradient(circle, rgba(187, 134, 252, 0.02) 0%, transparent 70%)",
            borderRadius: "50%",
            filter: "blur(30px)",
        ...
        {[...Array(8)].map((_, i) => (
          <div
            ...
            style={{
              ...
              width: "2px",
              height: "2px",
              background: `rgba(${100 + i * 10}, ${255 - i * 6}, ${
                218 - i * 4
              }, 0.3)`,
              borderRadius: "50%",
              top: `${Math.random() * 100}%`,
        ...
        >
          ...
          >
            ...
            <div style={{ maxWidth: "350px" }}>
              ...
              >
                Experience luxury and comfort at our premier hotel with
              ...
              >
                ...
                >
                  ...
                  >
                    <FiMapPin
                      style={{ color: "#64ffda", fontSize: "0.8rem" }}
                    />
                  </div>
                  <span
                    style={{
          ...
          >
            ...
            >
              <p style={{ margin: 0 }}>
                © {new Date().getFullYear()} Night Elegance. All rights
                reserved. |
                <span style={{ color: "#64ffda", marginLeft: "0.5rem" }}>
                  Made with{" "}
                  <FiHeart style={{ color: "#ff6b9d", display: "inline" }} />{" "}
