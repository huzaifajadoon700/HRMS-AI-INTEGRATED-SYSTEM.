...
import {
  ...
  tableUtils,
} from "../services/tableRecommendationService";
  ...
  const filterTables = async () => {
    ...
    if (reservationData.guests) {
      filtered = filtered.filter(
        (table) => table.capacity >= parseInt(reservationData.guests)
      );
    }
    ...
    if (reservationData.date && reservationData.time && filters.availability) {
      try {
        ...
        filtered = filtered.filter((table) =>
          availableTables.includes(table._id)
        );
      } catch (error) {
      ...
      >
        ...
        >
          ...
          >
            ...
            <p
              className="reserve-table-subtitle"
              style={{
                fontSize: "1.125rem",
                color: "#6b7280",
                margin: "0",
          ...
          >
            ...
            >
              <button
                ...
                style={{
                  ...
                  background:
                    activeTab === "recommendations" ? "#000000" : "#f3f4f6",
                  color:
                    activeTab === "recommendations" ? "#ffffff" : "#374151",
                  fontFamily: "Inter, sans-serif",
                }}
              >
                💝 RECOMMENDED FOR YOU
            ...
            {activeTab === "recommendations" ? (
              ...
              <div>
                ...
                <div
                  className="reserve-table-filters"
                  style={{
                ...
                >
                  ...
                  <div
                    className="reserve-table-filters-grid"
                    style={{
                      display: "grid",
                      gridTemplateColumns:
                  ...
                  <div
                    className="reserve-table-filters-grid-secondary"
                    style={{
                      display: "grid",
                      gridTemplateColumns:
                  ...
                  >
                    ...
                    {reservationData.date && reservationData.time && (
                      <span style={{ marginLeft: "0.5rem" }}>
                        for{" "}
                        {new Date(reservationData.date).toLocaleDateString()} at{" "}
              ...
              {loading ? (
                ...
                filteredTables.map((table) => (
                  ...
                  >
                    ...
                    {/* Card Content */}
                    <div
                      className="reserve-table-card-content"
                    ...
                    >
                      ...
                      >
                        <h3
                          className="reserve-table-card-title"
                          style={{
                            color: "#000000",
                            fontSize: "1.25rem",
                            fontWeight: "600",
                      ...
                      {/* Description */}
                      <p
                        className="reserve-table-card-description"
                        style={{
                          color: "#6b7280",
                          fontSize: "0.9rem",
                          lineHeight: "1.4",
                      ...
                      >
                        <div
                          className="reserve-table-feature"
                          style={{
                            display: "flex",
                            alignItems: "center",
                            gap: "0.5rem",
