/**
 * Home Page Component for HRMS Frontend
 * Main landing page with hero section, features, and recommendations
 *
 * @description Homepage with hotel services, testimonials, and AI recommendations
 * @version 1.0.0
 */
