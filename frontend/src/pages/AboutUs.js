/**
 * About Us Page Component for HRMS Frontend
 * Company information, team details, and hotel features showcase
 *
 * @description About page with interactive features and company story
 * @version 1.0.0
 */
              ...
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow =
                    "0 20px 40px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(100, 255, 218, 0.4)";
            ...
            {features.map((feature, index) => (
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    hoveredFeature === index
                      ? `0 20px 40px rgba(0, 0, 0, 0.4), 0 0 0 1px ${feature.color.replace(
                          ")",
                          ", 0.3)"
                        )}`
