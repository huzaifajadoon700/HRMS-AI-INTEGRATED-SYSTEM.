/**
 * Booking Controller for HRMS System
 * Handles hotel room reservations, payment processing, and booking management
 *
 * @description Controller for room booking operations with Stripe integration
 * @version 1.0.0
 */
...
// Create a new room booking with payment processing
...
exports.getBookingsByUser = async (req, res) => {
  try {
    ...
    if (bookings.length === 0) {
      ...
      bookings = await Booking.find({ userId: userId.toString() }).populate(
        "roomId"
      );
