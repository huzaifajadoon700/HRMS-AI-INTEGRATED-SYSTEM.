/**
 * Menu Controller for HRMS System
 * Restaurant menu management and food item operations
 *
 * @description Controller for menu CRUD operations and category management
 * @version 1.0.0
 */
