/**
 * Room Routes for HRMS System
 * API endpoints for hotel room management and AI recommendations
 *
 * @description Express router for room CRUD operations and ML recommendations
 * @version 1.0.0
 */
