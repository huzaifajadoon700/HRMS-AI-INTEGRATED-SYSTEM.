// Table Routes - Handles restaurant table management and reservation API endpoints
...
router.get(
  "/reserved-from-recommendations/:userId",
  ensureAuthenticated,
  getReservedTablesFromRecommendations
);
router.get(
  "/reserved-from-recommendations",
  ensureAuthenticated,
  getReservedTablesFromRecommendations
); // For current user
